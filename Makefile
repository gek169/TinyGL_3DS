...
LIBS	:= -lctru -lm `$(PREFIX)pkg-config opusfile --libs` -lcitro3d -lSDL -lSDL_mixer -lmad -logg -lmikmod -lvorbisidec -logg	-lSDL -lcitro3d -lctru -lm
...
export OFILES_BIN	:=	$(addsuffix .o,$(BINFILES)) \
				$(PNGFILES:.png=.bgr.o) $(addsuffix .o,$(BINFILES)) \
